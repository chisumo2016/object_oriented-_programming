...
$Account2 = new Savings( 50, "Cartoon  Insurance");  // Pass to the constructor
$Account2->APR = 12.0;
...
//Debit Account
//$Account3 = new Debit;
$Account3 = new Debit(30,"Spy  Insurance", 123 );
$Account3->APR = 0;
...
//$Account3->Validate(); now is private clas
...
echo  "<pre>" .print_r($Account3, true) . "</pre>";
